...
import sidebarBg from '../../assets/sidebar-bg3.jpg';
        ...
        <>
            ...
            >
                ...
                <SidebarFooter style={{ textAlign: 'center' }}>
                    ...
                    >
                        <a
                            href="https://github.com/pentaTTT"
                            target="_blank"
                            className="sidebar-btn text-decoration-none"
                            rel="noopener noreferrer"
                        >
                            <FaGithub />
                            <span style={{ whiteSpace: 'nowrap', textOverflow: 'ellipsis', overflow: 'hidden', paddingLeft: '3px' }}>
                                pentaTTT
                            </span>
                        </a>
                    </div>
